        ...
        data.forEach(student => {
            ...
            studentRow.innerHTML = `
                ...
                <td>
                    ...
                    <span class="badge ${student.student_status ===
                    "Active"
                    ? "green-badge"
                    : "yellow-badge"
                }">
...
function createReviewModal() {
    ...
    /*
     * Approve / Reject are intentionally
     * disabled at this stage.
     *
     * We will connect them to the database
     * after confirming the review interface.
     */
    ...
    document
        ...
        .addEventListener(
            ...
            () => {
                ...
                alert(
                    "Approval workflow will be added next."
                );
    ...
    document
        ...
        .addEventListener(
            ...
            () => {
                ...
                alert(
                    "Rejection workflow will be added next."
                );
